(function () {
  ...
  const STRINGS = {
    fr: {
      ...
      storySearchPlaceholder: 'Rechercher un conte...',
      storyReadToMe: 'Lis-moi l\'histoire',
      storyReadMyself: 'Je lis toute seule',
      storyQuizStart: 'Commencer le quiz',
      storyQuizQuestion: 'Question {{current}} / {{total}}',
      riddleCorrect: 'Bonne réponse !',
      riddleWrong: 'Presque ! Essaie encore.',
      riddleHintPrefix: 'Conseil :',
      riddleListenAria: 'Écouter l\'énigme',
      storyListenAria: 'Lire le conte en voix haute',
      storyReviewExplain: 'Souviens-toi de l\'histoire : {{answer}}.',
    ...
    en: {
      ...
      storySearchPlaceholder: 'Search a story...',
      storyReadToMe: 'Read the story to me',
      storyReadMyself: 'I read by myself',
      storyQuizStart: 'Start the quiz',
      storyQuizQuestion: 'Question {{current}} / {{total}}',
      riddleCorrect: 'Great answer!',
      riddleWrong: 'Almost! Try again.',
      riddleHintPrefix: 'Hint:',
      riddleListenAria: 'Listen to the riddle',
      storyListenAria: 'Read the story aloud',
      storyReviewExplain: 'Remember the story: {{answer}}.',
    ...
    es: {
      ...
      storySearchPlaceholder: 'Buscar un cuento...',
      storyReadToMe: 'Léeme el cuento',
      storyReadMyself: 'Yo leo sola',
      storyQuizStart: 'Empezar el quiz',
      storyQuizQuestion: 'Pregunta {{current}} / {{total}}',
      riddleCorrect: '¡Muy bien!',
      riddleWrong: '¡Casi! Inténtalo otra vez.',
      riddleHintPrefix: 'Pista:',
      riddleListenAria: 'Escuchar la adivinanza',
      storyListenAria: 'Leer el cuento en voz alta',
      storyReviewExplain: 'Recuerda el cuento: {{answer}}.',
    ...
    nl: {
      ...
      storySearchPlaceholder: 'Zoek een verhaal...',
      storyReadToMe: 'Lees het verhaal voor',
      storyReadMyself: 'Ik lees zelf',
      storyQuizStart: 'Start de quiz',
      storyQuizQuestion: 'Vraag {{current}} / {{total}}',
      riddleCorrect: 'Goed gedaan!',
      riddleWrong: 'Bijna! Probeer opnieuw.',
      riddleHintPrefix: 'Tip:',
      riddleListenAria: 'Luister naar het raadsel',
      storyListenAria: 'Lees het verhaal hardop',
      storyReviewExplain: 'Denk aan het verhaal: {{answer}}.',
