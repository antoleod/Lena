...
const GAME_SECTIONS = [
  {
    ...
    items: [
      { id: 'build-number', title: 'Construir números', level: '2º-3º', desc: 'Decenas y unidades con bloques base 10.', href: '/game?game=build-number&level=1' },
      { id: 'subtract-transform', title: 'Transformar y restar', level: '3º', desc: 'Restas con cambios de decenas y unidades.', href: '/game?game=subtract-transform&level=1' },
      { id: 'half-game', title: 'Mitades rápidas', level: '3º-4º', desc: 'Mitades y dobles con ejemplos guiados.', href: '/game?game=half-game&level=1' },
      { id: 'place-value', title: 'Valor posicional', level: '3º', desc: 'Componer y descomponer números con apoyo visual.', href: '/game?game=place-value&level=1' },
      { id: 'number-line', title: 'Recta numérica', level: '2º-3º', desc: 'Avanza o retrocede según la operación.', href: '/game?game=number-line&level=1' },
      { id: 'mult-div-families', title: 'Familias de multiplicar', level: '3º-4º', desc: 'Relaciona multiplicaciones y divisiones.', href: '/game?game=mult-div-families&level=1' },
      { id: 'word-problems', title: 'Problemas en texto', level: '3º-4º', desc: 'Lee y elige la operación correcta.', href: '/game?game=word-problems&level=1' }
    ]
  },
  {
    ...
    items: [
      { id: 'possessives', title: 'Possessifs en contexte', level: '2º-4º', desc: 'Elige el determinante correcto según el contexto.', href: '/game?game=possessives&level=1' }
    ]
  }
];
          ...
          <section key={section.title} className="allgames-section">
            ...
            <div className="allgames-cards">
              {section.items.map((item) => (
                <Link key={item.id} className="allgames-card" to={item.href}>
