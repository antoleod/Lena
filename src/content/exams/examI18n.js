...
export const EXAM_UI = {
  fr: {
    ...
    reviserErreurs: 'Réviser les erreurs',
    revisionsTitle: 'Révisions',
    revisionsDone: 'Bravo, révisions terminées !',
  ...
  nl: {
    ...
    loading: 'Laden…',
    restart: '🔄 Opnieuw',
    otherExams: '📚 Andere examens',
    prevPage: '← Vorige',
    listen: '🔊 Luisteren',
    startQuestions: 'Vragen beginnen →',
    muteOn: 'Geluid aan',
    muteOff: 'Geluid uit',
  },
  en: {
