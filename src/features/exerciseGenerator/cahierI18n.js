...
const UI = {
  fr: {
    ...
    format: 'Format', avecImages: 'Avec images', sansImages: 'Sans images',
    modeCahier: 'Mode cahier', modeExamen: 'Mode examen',
    aideVisuelle: 'Aide visuelle', genererHasard: '🎲 Générer au hasard',
    creerExercices: '✏️ Créer les exercices',
    nombresJusqua: 'Nombres de 0 à', voirCorrections: '👁️ Voir les corrections',
  ...
  nl: {
    ...
    format: 'Formaat', avecImages: 'Met afbeeldingen', sansImages: 'Zonder afbeeldingen',
    modeCahier: 'Schriftmodus', modeExamen: 'Exammodus',
    aideVisuelle: 'Visuele hulp', genererHasard: '🎲 Willekeurig genereren',
    creerExercices: '✏️ Oefeningen maken',
    nombresJusqua: 'Getallen van 0 tot', voirCorrections: '👁️ Verbeteringen tonen',
  ...
  en: {
    ...
    format: 'Format', avecImages: 'With images', sansImages: 'Without images',
    modeCahier: 'Notebook mode', modeExamen: 'Exam mode',
    aideVisuelle: 'Visual aid', genererHasard: '🎲 Generate randomly',
    creerExercices: '✏️ Create exercises',
    nombresJusqua: 'Numbers from 0 to', voirCorrections: '👁️ Show corrections',
  ...
  es: {
    ...
    format: 'Formato', avecImages: 'Con imágenes', sansImages: 'Sin imágenes',
    modeCahier: 'Modo cuaderno', modeExamen: 'Modo examen',
    aideVisuelle: 'Ayuda visual', genererHasard: '🎲 Generar al azar',
    creerExercices: '✏️ Crear ejercicios',
    nombresJusqua: 'Números de 0 a', voirCorrections: '👁️ Ver correcciones',
