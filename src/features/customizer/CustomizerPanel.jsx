...
// Page/section labels (also used by CustomizerPage for the header title).
export const CUSTOMIZER_LABELS = {
  fr: {
    ...
    parentsHint: 'Mot de passe, code secret et contrôle parental',
  },
  nl: {
    ...
    parents: 'Oudergedeelte',
    parentsHint: 'Wachtwoord, geheime code en ouderlijk toezicht',
  },
  es: {
    ...
    parents: 'Espacio de padres',
    parentsHint: 'Contraseña, código secreto y control parental',
  },
  en: {
    ...
    parentsHint: 'Password, secret code & parental controls',
  },
};

/** The customizer body (all sections + logic). Used by CustomizerPage. */
          ...
          {mascotColorOptions.map((color) => {
            ...
            return (
              ...
              >
                ...
                >
                  <img src={assetUrl('assets/characters/mascot-pair.svg')} alt="" draggable="false" />
                </span>
