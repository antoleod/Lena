const KEY = 'lena:chrono:v1';
function read() { try { return JSON.parse(localStorage.getItem(KEY) || '{}'); } catch { return {}; } }
function write(d) { try { localStorage.setItem(KEY, JSON.stringify(d)); } catch {} }
const DEFAULT = { totalCorrect: 0, totalAttempts: 0, badges: [], watchDesign: null, lastPlayed: null };
...
export function saveWatchDesign(design) { const p = loadProgress(); p.watchDesign = design; write(p); }
