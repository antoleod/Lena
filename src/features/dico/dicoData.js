...
export const DICO_WORDS = [
  ...
  // VOCABULAIRE DES EXERCICES (qualites, actions) — synonymes & contraires
  {
    id:'rapide', word:'rapide', genre:'m', class:'adjectif', emoji:'🏃', theme:'qualites', level:1,
    definition:'Qui va tres vite, qui ne met pas longtemps.',
    example:'Le guepard est tres rapide a la course.',
    synonyms:['vite','prompt'], antonym:'lent', family:['vitesse','courir'],
    i18n:{
      nl:{ word:'snel', definition:'Iets dat heel vlug gaat en weinig tijd nodig heeft.', example:'De jachtluipaard is heel snel.' },
      en:{ word:'fast', definition:'Something that goes very quickly and takes little time.', example:'The cheetah is very fast.' },
      es:{ word:'rapido', definition:'Que va muy deprisa y tarda poco.', example:'El guepardo es muy rapido.' },
    },
  },
  {
    id:'content', word:'content', genre:'m', class:'adjectif', emoji:'😊', theme:'emotions', level:1,
    definition:'Qui se sent bien et heureux.',
    example:'Je suis content de revoir mes amis.',
    synonyms:['heureux','joyeux'], antonym:'triste', family:['joie','sourire'],
    i18n:{
      nl:{ word:'blij', definition:'Iemand die zich goed en gelukkig voelt.', example:'Ik ben blij mijn vrienden weer te zien.' },
      en:{ word:'happy', definition:'Someone who feels good and glad.', example:'I am happy to see my friends again.' },
      es:{ word:'contento', definition:'Que se siente bien y feliz.', example:'Estoy contento de ver a mis amigos.' },
    },
  },
  {
    id:'beau', word:'beau', genre:'m', class:'adjectif', emoji:'✨', theme:'qualites', level:1,
    definition:'Qui plait a regarder, agreable a voir.',
    example:'Quel beau coucher de soleil !',
    synonyms:['joli','magnifique'], antonym:'laid', family:['beaute','joli'],
    i18n:{
      nl:{ word:'mooi', definition:'Iets dat leuk is om naar te kijken.', example:'Wat een mooie zonsondergang!' },
      en:{ word:'beautiful', definition:'Pleasant and nice to look at.', example:'What a beautiful sunset!' },
      es:{ word:'bonito', definition:'Que gusta mirar, agradable a la vista.', example:'Que bonito atardecer!' },
    },
  },
  {
    id:'grand', word:'grand', genre:'m', class:'adjectif', emoji:'📏', theme:'qualites', level:1,
    definition:'Qui prend beaucoup de place, en hauteur ou en taille.',
    example:'Mon frere est tres grand.',
    synonyms:['immense'], antonym:'petit', family:['taille','hauteur'],
    i18n:{
      nl:{ word:'groot', definition:'Iets dat veel plaats inneemt of hoog is.', example:'Mijn broer is heel groot.' },
      en:{ word:'big', definition:'Something that takes a lot of space or is tall.', example:'My brother is very big.' },
      es:{ word:'grande', definition:'Que ocupa mucho espacio o es alto.', example:'Mi hermano es muy grande.' },
    },
  },
  {
    id:'petit', word:'petit', genre:'m', class:'adjectif', emoji:'🐭', theme:'qualites', level:1,
    definition:'Qui prend peu de place, qui n est pas grand.',
    example:'La souris est un petit animal.',
    synonyms:['minuscule'], antonym:'grand', family:['taille','mini'],
    i18n:{
      nl:{ word:'klein', definition:'Iets dat weinig plaats inneemt, niet groot.', example:'De muis is een klein dier.' },
      en:{ word:'small', definition:'Something that takes little space, not big.', example:'The mouse is a small animal.' },
      es:{ word:'pequeno', definition:'Que ocupa poco espacio, que no es grande.', example:'El raton es un animal pequeno.' },
    },
  },
  {
    id:'fort', word:'fort', genre:'m', class:'adjectif', emoji:'💪', theme:'qualites', level:1,
    definition:'Qui a beaucoup de force ou de puissance.',
    example:'L elephant est un animal tres fort.',
    synonyms:['puissant','costaud'], antonym:'faible', family:['force','muscle'],
    i18n:{
      nl:{ word:'sterk', definition:'Iemand of iets met veel kracht.', example:'De olifant is een heel sterk dier.' },
      en:{ word:'strong', definition:'Having a lot of strength or power.', example:'The elephant is a very strong animal.' },
      es:{ word:'fuerte', definition:'Que tiene mucha fuerza o potencia.', example:'El elefante es un animal muy fuerte.' },
    },
  },
  {
    id:'gentil', word:'gentil', genre:'m', class:'adjectif', emoji:'🤗', theme:'qualites', level:1,
    definition:'Qui est doux et aimable avec les autres.',
    example:'Ma voisine est tres gentille avec moi.',
    synonyms:['aimable'], antonym:'mechant', family:['gentillesse','aimable'],
    i18n:{
      nl:{ word:'aardig', definition:'Iemand die lief en vriendelijk is voor anderen.', example:'Mijn buurvrouw is heel aardig.' },
      en:{ word:'kind', definition:'Being nice and friendly to others.', example:'My neighbour is very kind to me.' },
      es:{ word:'amable', definition:'Que es dulce y simpatico con los demas.', example:'Mi vecina es muy amable conmigo.' },
    },
  },
  {
    id:'facile', word:'facile', genre:'m', class:'adjectif', emoji:'👍', theme:'qualites', level:1,
    definition:'Qui ne demande pas beaucoup d effort, simple a faire.',
    example:'Ce jeu est facile a comprendre.',
    synonyms:['simple','aise'], antonym:'difficile', family:['simple','aise'],
    i18n:{
      nl:{ word:'makkelijk', definition:'Iets dat weinig moeite kost, eenvoudig te doen.', example:'Dit spel is makkelijk te begrijpen.' },
      en:{ word:'easy', definition:'Needing little effort, simple to do.', example:'This game is easy to understand.' },
      es:{ word:'facil', definition:'Que no cuesta mucho esfuerzo, sencillo de hacer.', example:'Este juego es facil de entender.' },
    },
  },
  {
    id:'difficile', word:'difficile', genre:'m', class:'adjectif', emoji:'😣', theme:'qualites', level:1,
    definition:'Qui demande beaucoup d effort, pas facile.',
    example:'Ce probleme est difficile a resoudre.',
    synonyms:['dur','ardu'], antonym:'facile', family:['effort','dur'],
    i18n:{
      nl:{ word:'moeilijk', definition:'Iets dat veel moeite kost, niet makkelijk.', example:'Dit probleem is moeilijk op te lossen.' },
      en:{ word:'difficult', definition:'Needing a lot of effort, not easy.', example:'This problem is difficult to solve.' },
      es:{ word:'dificil', definition:'Que cuesta mucho esfuerzo, no es facil.', example:'Este problema es dificil de resolver.' },
    },
  },
  {
    id:'intelligent', word:'intelligent', genre:'m', class:'adjectif', emoji:'🧠', theme:'qualites', level:2,
    definition:'Qui comprend et apprend vite.',
    example:'Ce chien est tres intelligent.',
    synonyms:['malin','fute'], antonym:'bete', family:['esprit','malin'],
    i18n:{
      nl:{ word:'slim', definition:'Iemand die snel begrijpt en leert.', example:'Deze hond is heel slim.' },
      en:{ word:'clever', definition:'Who understands and learns quickly.', example:'This dog is very clever.' },
      es:{ word:'inteligente', definition:'Que entiende y aprende rapido.', example:'Este perro es muy inteligente.' },
    },
  },
  {
    id:'tranquille', word:'tranquille', genre:'m', class:'adjectif', emoji:'😌', theme:'emotions', level:2,
    definition:'Qui est calme, sans bruit ni agitation.',
    example:'Le bebe dort, reste tranquille.',
    synonyms:['calme','paisible'], antonym:'agite', family:['calme','repos'],
    i18n:{
      nl:{ word:'rustig', definition:'Iets dat kalm is, zonder lawaai of drukte.', example:'De baby slaapt, blijf rustig.' },
      en:{ word:'calm', definition:'Quiet, with no noise or fuss.', example:'The baby sleeps, stay calm.' },
      es:{ word:'tranquilo', definition:'Que esta en calma, sin ruido ni agitacion.', example:'El bebe duerme, quedate tranquilo.' },
    },
  },
  {
    id:'magnifique', word:'magnifique', genre:'m', class:'adjectif', emoji:'🌟', theme:'qualites', level:2,
    definition:'Tres beau, qui emerveille.',
    example:'La vue depuis la montagne est magnifique.',
    synonyms:['splendide','superbe'], antonym:'horrible', family:['beaute','splendide'],
    i18n:{
      nl:{ word:'prachtig', definition:'Heel mooi, iets dat je verwondert.', example:'Het uitzicht vanaf de berg is prachtig.' },
      en:{ word:'magnificent', definition:'Very beautiful, amazing to see.', example:'The view from the mountain is magnificent.' },
      es:{ word:'magnifico', definition:'Muy bonito, que maravilla.', example:'La vista desde la montana es magnifica.' },
    },
  },
  {
    id:'bizarre', word:'bizarre', genre:'m', class:'adjectif', emoji:'🤨', theme:'qualites', level:2,
    definition:'Qui est etrange, pas comme d habitude.',
    example:'J ai entendu un bruit bizarre.',
    synonyms:['etrange','curieux'], antonym:'normal', family:['etrange','curieux'],
    i18n:{
      nl:{ word:'raar', definition:'Iets vreemds, niet zoals gewoonlijk.', example:'Ik hoorde een raar geluid.' },
      en:{ word:'strange', definition:'Odd, not like usual.', example:'I heard a strange noise.' },
      es:{ word:'raro', definition:'Que es extrano, no como de costumbre.', example:'Oi un ruido raro.' },
    },
  },
  {
    id:'ancien', word:'ancien', genre:'m', class:'adjectif', emoji:'🏛️', theme:'maison', level:2,
    definition:'Qui existe depuis tres longtemps, du passe.',
    example:'Ce chateau est tres ancien.',
    synonyms:['vieux','antique'], antonym:'nouveau', family:['passe','vieux'],
    i18n:{
      nl:{ word:'oud', definition:'Iets dat al heel lang bestaat, uit vroeger.', example:'Dit kasteel is heel oud.' },
      en:{ word:'old', definition:'Existing for a very long time, from the past.', example:'This castle is very old.' },
      es:{ word:'antiguo', definition:'Que existe desde hace mucho tiempo, del pasado.', example:'Este castillo es muy antiguo.' },
    },
  },
  {
    id:'chaud', word:'chaud', genre:'m', class:'adjectif', emoji:'🔥', theme:'nature', level:1,
    definition:'Qui a une temperature elevee, qui brule un peu.',
    example:'La soupe est encore chaude.',
    synonyms:['brulant'], antonym:'froid', family:['temperature','feu'],
    i18n:{
      nl:{ word:'warm', definition:'Iets met een hoge temperatuur, een beetje heet.', example:'De soep is nog warm.' },
      en:{ word:'hot', definition:'Having a high temperature, a bit burning.', example:'The soup is still hot.' },
      es:{ word:'caliente', definition:'Que tiene una temperatura alta, que quema un poco.', example:'La sopa todavia esta caliente.' },
    },
  },
  {
    id:'propre', word:'propre', genre:'m', class:'adjectif', emoji:'🧼', theme:'maison', level:1,
    definition:'Qui est bien nettoye, sans salete.',
    example:'Mes mains sont propres apres le lavage.',
    synonyms:['net','impeccable'], antonym:'sale', family:['proprete','laver'],
    i18n:{
      nl:{ word:'schoon', definition:'Iets dat goed schoongemaakt is, zonder vuil.', example:'Mijn handen zijn schoon na het wassen.' },
      en:{ word:'clean', definition:'Well washed, without dirt.', example:'My hands are clean after washing.' },
      es:{ word:'limpio', definition:'Que esta bien limpio, sin suciedad.', example:'Mis manos estan limpias tras lavarlas.' },
    },
  },
  {
    id:'ouvert', word:'ouvert', genre:'m', class:'adjectif', emoji:'🚪', theme:'maison', level:1,
    definition:'Qui n est pas ferme, par ou on peut passer.',
    example:'La porte est grande ouverte.',
    synonyms:['beant'], antonym:'ferme', family:['porte','entrer'],
    i18n:{
      nl:{ word:'open', definition:'Iets dat niet dicht is, waar je door kunt.', example:'De deur staat wijd open.' },
      en:{ word:'open', definition:'Not closed, that you can pass through.', example:'The door is wide open.' },
      es:{ word:'abierto', definition:'Que no esta cerrado, por donde se puede pasar.', example:'La puerta esta abierta de par en par.' },
    },
  },
  {
    id:'haut', word:'haut', genre:'m', class:'adjectif', emoji:'⛰️', theme:'nature', level:1,
    definition:'Qui monte loin vers le ciel, grande hauteur.',
    example:'La montagne est tres haute.',
    synonyms:['eleve'], antonym:'bas', family:['hauteur','sommet'],
    i18n:{
      nl:{ word:'hoog', definition:'Iets dat ver naar de hemel reikt.', example:'De berg is heel hoog.' },
      en:{ word:'high', definition:'Reaching far up toward the sky.', example:'The mountain is very high.' },
      es:{ word:'alto', definition:'Que sube lejos hacia el cielo.', example:'La montana es muy alta.' },
    },
  },
  {
    id:'vieux', word:'vieux', genre:'m', class:'adjectif', emoji:'👴', theme:'famille', level:1,
    definition:'Qui a beaucoup d annees, age depuis longtemps.',
    example:'Mon grand-pere est tres vieux.',
    synonyms:['age','ancien'], antonym:'jeune', family:['age','grand-pere'],
    i18n:{
      nl:{ word:'oud', definition:'Iemand of iets met veel jaren.', example:'Mijn opa is heel oud.' },
      en:{ word:'old', definition:'Having many years, aged.', example:'My grandfather is very old.' },
      es:{ word:'viejo', definition:'Que tiene muchos anos.', example:'Mi abuelo es muy viejo.' },
    },
  },
  {
    id:'premier', word:'premier', genre:'m', class:'adjectif', emoji:'🥇', theme:'ecole', level:1,
    definition:'Qui vient avant tous les autres, en tete.',
    example:'Il est arrive premier a la course.',
    synonyms:['initial'], antonym:'dernier', family:['ordre','debut'],
    i18n:{
      nl:{ word:'eerste', definition:'Iets dat voor alle andere komt, vooraan.', example:'Hij kwam als eerste bij de race.' },
      en:{ word:'first', definition:'Coming before all the others.', example:'He came first in the race.' },
      es:{ word:'primero', definition:'Que viene antes que todos los demas.', example:'Llego primero en la carrera.' },
    },
  },
  {
    id:'riche', word:'riche', genre:'m', class:'adjectif', emoji:'💰', theme:'maison', level:2,
    definition:'Qui a beaucoup d argent ou de choses.',
    example:'Le roi etait tres riche.',
    synonyms:['fortune'], antonym:'pauvre', family:['argent','fortune'],
    i18n:{
      nl:{ word:'rijk', definition:'Iemand met veel geld of bezit.', example:'De koning was heel rijk.' },
      en:{ word:'rich', definition:'Having a lot of money or things.', example:'The king was very rich.' },
      es:{ word:'rico', definition:'Que tiene mucho dinero o cosas.', example:'El rey era muy rico.' },
    },
  },
  {
    id:'plein', word:'plein', genre:'m', class:'adjectif', emoji:'🫗', theme:'maison', level:2,
    definition:'Qui contient beaucoup, rempli au maximum.',
    example:'Le verre est plein d eau.',
    synonyms:['rempli'], antonym:'vide', family:['rempli','contenir'],
    i18n:{
      nl:{ word:'vol', definition:'Iets dat veel bevat, helemaal gevuld.', example:'Het glas is vol water.' },
      en:{ word:'full', definition:'Containing a lot, filled to the top.', example:'The glass is full of water.' },
      es:{ word:'lleno', definition:'Que contiene mucho, lleno al maximo.', example:'El vaso esta lleno de agua.' },
    },
  },
  {
    id:'leger', word:'léger', genre:'m', class:'adjectif', emoji:'🪶', theme:'nature', level:2,
    definition:'Qui ne pese presque rien, facile a porter.',
    example:'La plume est tres legere.',
    synonyms:['plume'], antonym:'lourd', family:['poids','plume'],
    i18n:{
      nl:{ word:'licht', definition:'Iets dat bijna niets weegt, makkelijk te dragen.', example:'De veer is heel licht.' },
      en:{ word:'light', definition:'Weighing almost nothing, easy to carry.', example:'The feather is very light.' },
      es:{ word:'ligero', definition:'Que pesa casi nada, facil de llevar.', example:'La pluma es muy ligera.' },
    },
  },
  {
    id:'dur', word:'dur', genre:'m', class:'adjectif', emoji:'🪨', theme:'nature', level:2,
    definition:'Qui est solide et resiste, pas mou.',
    example:'La pierre est tres dure.',
    synonyms:['solide','rigide'], antonym:'mou', family:['solide','pierre'],
    i18n:{
      nl:{ word:'hard', definition:'Iets dat stevig is en weerstaat, niet zacht.', example:'De steen is heel hard.' },
      en:{ word:'hard', definition:'Solid and resistant, not soft.', example:'The stone is very hard.' },
      es:{ word:'duro', definition:'Que es solido y resiste, no blando.', example:'La piedra es muy dura.' },
    },
  },
  {
    id:'mouille', word:'mouillé', genre:'m', class:'adjectif', emoji:'💧', theme:'nature', level:2,
    definition:'Qui est couvert ou rempli d eau.',
    example:'Mes habits sont mouilles par la pluie.',
    synonyms:['trempe','humide'], antonym:'sec', family:['eau','pluie'],
    i18n:{
      nl:{ word:'nat', definition:'Iets dat bedekt of vol water is.', example:'Mijn kleren zijn nat van de regen.' },
      en:{ word:'wet', definition:'Covered or filled with water.', example:'My clothes are wet from the rain.' },
      es:{ word:'mojado', definition:'Que esta cubierto o lleno de agua.', example:'Mi ropa esta mojada por la lluvia.' },
    },
  },
  {
    id:'blanc', word:'blanc', genre:'m', class:'adjectif', emoji:'⚪', theme:'nature', level:1,
    definition:'De la couleur de la neige et du lait.',
    example:'La neige est toute blanche.',
    synonyms:['immacule'], antonym:'noir', family:['couleur','neige'],
    i18n:{
      nl:{ word:'wit', definition:'De kleur van sneeuw en melk.', example:'De sneeuw is helemaal wit.' },
      en:{ word:'white', definition:'The colour of snow and milk.', example:'The snow is all white.' },
      es:{ word:'blanco', definition:'Del color de la nieve y la leche.', example:'La nieve es toda blanca.' },
    },
  },
  {
    id:'clair', word:'clair', genre:'m', class:'adjectif', emoji:'💡', theme:'nature', level:2,
    definition:'Qui a beaucoup de lumiere, facile a voir.',
    example:'La piece est bien claire le matin.',
    synonyms:['lumineux'], antonym:'sombre', family:['lumiere','clarte'],
    i18n:{
      nl:{ word:'helder', definition:'Iets met veel licht, goed te zien.', example:'De kamer is goed verlicht.' },
      en:{ word:'clear', definition:'Full of light, easy to see.', example:'The room is bright in the morning.' },
      es:{ word:'claro', definition:'Que tiene mucha luz, facil de ver.', example:'La habitacion es clara por la manana.' },
    },
  },
  {
    id:'vivant', word:'vivant', genre:'m', class:'adjectif', emoji:'🌱', theme:'nature', level:2,
    definition:'Qui est en vie, qui respire et bouge.',
    example:'La plante est bien vivante.',
    synonyms:['vif'], antonym:'mort', family:['vie','respirer'],
    i18n:{
      nl:{ word:'levend', definition:'Iets dat leeft, ademt en beweegt.', example:'De plant is goed levend.' },
      en:{ word:'alive', definition:'Being alive, breathing and moving.', example:'The plant is very much alive.' },
      es:{ word:'vivo', definition:'Que esta vivo, respira y se mueve.', example:'La planta esta bien viva.' },
    },
  },
  {
    id:'doux', word:'doux', genre:'m', class:'adjectif', emoji:'🧸', theme:'qualites', level:2,
    definition:'Qui est agreable a toucher, ni dur ni piquant.',
    example:'Le chaton a un poil tres doux.',
    synonyms:['tendre','moelleux'], antonym:'dur', family:['tendre','caresse'],
    i18n:{
      nl:{ word:'zacht', definition:'Iets dat prettig aanvoelt, niet hard.', example:'Het katje heeft heel zacht haar.' },
      en:{ word:'soft', definition:'Pleasant to touch, not hard.', example:'The kitten has very soft fur.' },
      es:{ word:'suave', definition:'Que es agradable al tacto, ni duro ni aspero.', example:'El gatito tiene un pelo muy suave.' },
    },
  },
  {
    id:'commencer', word:'commencer', genre:'m', class:'verbe', emoji:'▶️', theme:'actions', level:1,
    definition:'Faire le debut de quelque chose.',
    example:'La classe commence a huit heures.',
    synonyms:['debuter'], antonym:'finir', family:['debut','depart'],
    i18n:{
      nl:{ word:'beginnen', definition:'Het begin van iets doen.', example:'De les begint om acht uur.' },
      en:{ word:'to begin', definition:'To do the start of something.', example:'Class begins at eight.' },
      es:{ word:'empezar', definition:'Hacer el principio de algo.', example:'La clase empieza a las ocho.' },
    },
  },
  {
    id:'finir', word:'finir', genre:'m', class:'verbe', emoji:'🏁', theme:'actions', level:1,
    definition:'Arriver a la fin, terminer quelque chose.',
    example:'J ai fini mes devoirs.',
    synonyms:['terminer','achever'], antonym:'commencer', family:['fin','terminer'],
    i18n:{
      nl:{ word:'eindigen', definition:'Bij het einde komen, iets afmaken.', example:'Ik ben klaar met mijn huiswerk.' },
      en:{ word:'to finish', definition:'To reach the end of something.', example:'I finished my homework.' },
      es:{ word:'terminar', definition:'Llegar al final, acabar algo.', example:'Termine mis deberes.' },
    },
  },
  {
    id:'chercher', word:'chercher', genre:'m', class:'verbe', emoji:'🔎', theme:'actions', level:1,
    definition:'Essayer de trouver quelque chose.',
    example:'Je cherche mes lunettes partout.',
    synonyms:['rechercher'], antonym:'trouver', family:['trouver','fouiller'],
    i18n:{
      nl:{ word:'zoeken', definition:'Proberen iets te vinden.', example:'Ik zoek overal mijn bril.' },
      en:{ word:'to look for', definition:'To try to find something.', example:'I look for my glasses everywhere.' },
      es:{ word:'buscar', definition:'Intentar encontrar algo.', example:'Busco mis gafas por todas partes.' },
    },
  },
  {
    id:'aider', word:'aider', genre:'m', class:'verbe', emoji:'🤝', theme:'actions', level:1,
    definition:'Donner un coup de main a quelqu un.',
    example:'J aide ma maman a ranger.',
    synonyms:['assister','secourir'], antonym:'gener', family:['entraide','soutien'],
    i18n:{
      nl:{ word:'helpen', definition:'Iemand een handje toesteken.', example:'Ik help mama met opruimen.' },
      en:{ word:'to help', definition:'To give someone a hand.', example:'I help my mum tidy up.' },
      es:{ word:'ayudar', definition:'Echar una mano a alguien.', example:'Ayudo a mi mama a ordenar.' },
    },
  },
  {
    id:'entrer', word:'entrer', genre:'m', class:'verbe', emoji:'🚶', theme:'actions', level:1,
    definition:'Aller a l interieur d un endroit.',
    example:'Entre dans la maison, il fait froid.',
    synonyms:['penetrer'], antonym:'sortir', family:['porte','interieur'],
    i18n:{
      nl:{ word:'binnenkomen', definition:'Naar de binnenkant van een plek gaan.', example:'Kom binnen, het is koud.' },
      en:{ word:'to enter', definition:'To go inside a place.', example:'Come into the house, it is cold.' },
      es:{ word:'entrar', definition:'Ir al interior de un lugar.', example:'Entra en la casa, hace frio.' },
    },
  },
  {
    id:'monter', word:'monter', genre:'m', class:'verbe', emoji:'🧗', theme:'actions', level:2,
    definition:'Aller vers le haut.',
    example:'Je monte l escalier jusqu au grenier.',
    synonyms:['grimper','gravir'], antonym:'descendre', family:['escalier','grimper'],
    i18n:{
      nl:{ word:'klimmen', definition:'Naar boven gaan.', example:'Ik klim de trap op naar de zolder.' },
      en:{ word:'to go up', definition:'To go upward.', example:'I go up the stairs to the attic.' },
      es:{ word:'subir', definition:'Ir hacia arriba.', example:'Subo la escalera hasta el desvan.' },
    },
  },
  {
    id:'accepter', word:'accepter', genre:'m', class:'verbe', emoji:'🙆', theme:'actions', level:2,
    definition:'Dire oui, vouloir bien recevoir ou faire.',
    example:'J accepte ton invitation avec plaisir.',
    synonyms:['admettre'], antonym:'refuser', family:['oui','admettre'],
    i18n:{
      nl:{ word:'aanvaarden', definition:'Ja zeggen, iets graag ontvangen of doen.', example:'Ik aanvaard je uitnodiging graag.' },
      en:{ word:'to accept', definition:'To say yes, to agree to take or do.', example:'I accept your invitation gladly.' },
      es:{ word:'aceptar', definition:'Decir que si, querer recibir o hacer algo.', example:'Acepto tu invitacion con gusto.' },
    },
  },
  {
    id:'donner', word:'donner', genre:'m', class:'verbe', emoji:'🎁', theme:'actions', level:1,
    definition:'Offrir quelque chose a quelqu un.',
    example:'Je donne un bonbon a mon ami.',
    synonyms:['offrir'], antonym:'prendre', family:['offrir','cadeau'],
    i18n:{
      nl:{ word:'geven', definition:'Iemand iets aanbieden.', example:'Ik geef mijn vriend een snoepje.' },
      en:{ word:'to give', definition:'To offer something to someone.', example:'I give a sweet to my friend.' },
      es:{ word:'dar', definition:'Ofrecer algo a alguien.', example:'Le doy un caramelo a mi amigo.' },
    },
  },
  {
    id:'gagner', word:'gagner', genre:'m', class:'verbe', emoji:'🏆', theme:'actions', level:2,
    definition:'Etre le premier, remporter une partie.',
    example:'Notre equipe a gagne le match.',
    synonyms:['remporter'], antonym:'perdre', family:['victoire','prix'],
    i18n:{
      nl:{ word:'winnen', definition:'De eerste zijn, een spel winnen.', example:'Ons team heeft de wedstrijd gewonnen.' },
      en:{ word:'to win', definition:'To be first, to take a victory.', example:'Our team won the match.' },
      es:{ word:'ganar', definition:'Ser el primero, llevarse un juego.', example:'Nuestro equipo gano el partido.' },
    },
  },
  {
    id:'allumer', word:'allumer', genre:'m', class:'verbe', emoji:'💡', theme:'maison', level:2,
    definition:'Faire marcher une lumiere ou un appareil.',
    example:'J allume la lampe pour lire.',
    synonyms:['activer'], antonym:'eteindre', family:['lumiere','lampe'],
    i18n:{
      nl:{ word:'aansteken', definition:'Een licht of toestel laten werken.', example:'Ik doe de lamp aan om te lezen.' },
      en:{ word:'to turn on', definition:'To make a light or device work.', example:'I turn on the lamp to read.' },
      es:{ word:'encender', definition:'Hacer funcionar una luz o aparato.', example:'Enciendo la lampara para leer.' },
    },
  },
  {
    id:'aimer', word:'aimer', genre:'m', class:'verbe', emoji:'❤️', theme:'emotions', level:1,
    definition:'Avoir beaucoup d affection pour, apprecier.',
    example:'J aime jouer avec mes amis.',
    synonyms:['adorer'], antonym:'detester', family:['affection','adorer'],
    i18n:{
      nl:{ word:'houden van', definition:'Veel genegenheid voor iets of iemand hebben.', example:'Ik hou ervan met mijn vrienden te spelen.' },
      en:{ word:'to love', definition:'To feel a lot of affection for, to enjoy.', example:'I love playing with my friends.' },
      es:{ word:'querer', definition:'Tener mucho carino por algo, disfrutarlo.', example:'Me gusta jugar con mis amigos.' },
    },
  },
  {
    id:'avancer', word:'avancer', genre:'m', class:'verbe', emoji:'➡️', theme:'actions', level:2,
    definition:'Aller vers l avant.',
    example:'La voiture avance lentement.',
    synonyms:['progresser'], antonym:'reculer', family:['avant','progresser'],
    i18n:{
      nl:{ word:'vooruitgaan', definition:'Naar voren gaan.', example:'De auto gaat langzaam vooruit.' },
      en:{ word:'to move forward', definition:'To go toward the front.', example:'The car moves forward slowly.' },
      es:{ word:'avanzar', definition:'Ir hacia adelante.', example:'El coche avanza despacio.' },
    },
  },
  {
    id:'cacher', word:'cacher', genre:'m', class:'verbe', emoji:'🙈', theme:'actions', level:2,
    definition:'Mettre a l abri des regards, ne pas montrer.',
    example:'Je cache le cadeau sous le lit.',
    synonyms:['dissimuler'], antonym:'montrer', family:['secret','abri'],
    i18n:{
      nl:{ word:'verstoppen', definition:'Iets uit het zicht leggen, niet tonen.', example:'Ik verstop het cadeau onder het bed.' },
      en:{ word:'to hide', definition:'To keep out of sight, not to show.', example:'I hide the gift under the bed.' },
      es:{ word:'esconder', definition:'Poner algo fuera de la vista, no mostrarlo.', example:'Escondo el regalo bajo la cama.' },
    },
  },
  {
    id:'jour', word:'jour', genre:'m', class:'nom', emoji:'☀️', theme:'nature', level:1,
    definition:'Le moment ou il fait clair, entre deux nuits.',
    example:'Le jour se leve a six heures.',
    synonyms:['journee'], antonym:'nuit', family:['journee','soleil'],
    i18n:{
      nl:{ word:'dag', definition:'Het moment waarop het licht is, tussen twee nachten.', example:'De dag breekt aan om zes uur.' },
      en:{ word:'day', definition:'The time when it is light, between two nights.', example:'The day begins at six.' },
      es:{ word:'dia', definition:'El momento en que hay luz, entre dos noches.', example:'El dia empieza a las seis.' },
    },
  },
];
